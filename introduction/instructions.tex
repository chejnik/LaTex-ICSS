...
U~některých heslových slov jsou v~záhlaví hesla uvedeny varianty (obměny) nebo dublety (dvojtvary).
...
\blspace
\item V~případě, že se v~hesle vyskytuje více dělení, jsou použity dvě střední tečky \textbf{'··'} pro hlavní dělení a~jedna střední tečka \textbf{'·'} pro zbylé\,/\addthin zbylá dělení.
\blspace
...
Pokud není hnízdovací šev \textbf{'|'} uveden, pak se koncovka připojuje k~celému heslu.
...
Pokud přídavné jméno v~ženském rodě neztrácí koncové '\textit{-r}', je uveden tvar hesla v~ženském rodě takto:
...
je schopen (více méně) z~těchto tvarů odvodit časování slovesa. V~tomto slovníku 

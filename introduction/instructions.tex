...
\blspace
  \dicEntry \dicTerm{tím|i} \dicPos{m} \dicFlx{(-a, -ar)} {\textbf{1.}} \dicSynonym{tíð} {čas, doba}; \textbf{í þann tíma} \dicFlx{adv} \dicSynonym{þá\textsuperscript{2}} {v té době, tou dobou} {\textbf{2.}} \dicSynonym{rétt stund} {(správný) čas / moment}
\blspace
...
Dále následují slovní spojení ve~středním slovesném rodě řazená opět podle předložky / příslovce / zájmena, se kterým se pojí:

...
\def\tableC{\noindent\begin{tabularx}{\columnwidth}
  ...
  \toprule
  \multirow{4}{*}{f\textsubscript{1} \textsubscript{7}}
...
Další informace o~numerickém systému lze nalézt v~sekci \ref{sec:dec} na straně \pageref{sec:dec}.
\end{enumerate}
...
V~záhlaví hesla se kromě deklinačních / konjugačních koncovek nachází také morfologické numerické informace, které odkazují na morfologický klíč (viz \ref{sec:morpho} na straně \pageref{sec:morpho}), kde jsou podrobně vypsány kompletní deklinační / konjugační tabulky.

...
\blspace
\item V~případě, že se v~hesle vyskytuje více dělení, jsou použity dvě střední tečky \textbf{'··'} pro významově poslední dělení a~jedna střední tečka \textbf{'·'} pro zbylé\,/\addthin zbylá dělení.
\blspace
...
Pokud není hnízdovací šev \textbf{'|'} uveden, pak se koncovka připojuje k~samotnému heslu.
...
Názvy podtříd slouží pro rozlišení odlišných skloňování\,/\addthin časování.

...
\blspace
  \dicEntry \dicTerm{drag} {\dicPos{n} \dicFlx{(-s, drög)} {\textbf{1.}} {mokřina, podmoklý terén;} {\textbf{2.}} \textbf{drög} {\footnotesize{pl}} {\textbf{a.}} \dicSynonym{uppsprettur} {prameny (řeky ap.);} {\textbf{b.}} \dicSynonym{undirbúningur} {náčtr, návrh.}}
\blspace
...
Zde máme na mysli informace o~pádě (\textbf{nom, acc, dat, gen}), slovesu v~středním slovesném rodě (\textbf{refl}), neosobním slovesu (\textbf{impers}), čísle (\textbf{sg, pl}), rozkazovazím způsobu (\textbf{imper}) a~spojovacím způsobu (\textbf{con}).
...
Ve slovních spojeních používáme zkratky pro tvary neurčitého zájmena \textbf{einhver} (někdo) a~\textbf{eitthvað} (něco). Tyto zkratky naznačují a) pád, b) číslo a~c) životnost nebo neživotnost podmětu / předmětu.\\

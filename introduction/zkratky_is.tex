...
\item[{e-að}] {(et. nf. ólifandi) (\textit{eitthvað})}
\item[{e-ð}] { (et. þf. ólifandi) (\textit{eitthvað})}
...
\item[{e-s}] {(et. ef. ólifandi) (\textit{einhvers})}
\item[{e-u}] {(et. þgf. ólifandi) (\textit{einhverju})}

...
\newif\ifPRINTHOUSE 	   \PRINTHOUSEfalse
\newif\ifPDFSEARCH  	   \PDFSEARCHtrue
...
\newlength{\thumbwidth}                \setlength{\thumbwidth}{1cm}
\newlength{\thumbheight}
...
\newlength{\thumbsep}                  \setlength{\thumbsep}{.25cm}
% overlap over cutting line
\newlength{\thumboverlap}              \setlength{\thumboverlap}{.5cm}

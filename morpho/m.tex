...
\multirow{3}{*}{{{\textbf{m{\textsubscript{10}}} \Large{\textbf{40}}}}} & nom & ·aður & ·aðurinn & \textbf{svörtumarkaðir} & \textls[-5]{svörtumarkaðirnir} \\*
 & acc & svartamarkað & svartamarkaðinn & svörtumarkaði & \textls[-5]{svörtumarkaðina} \\*
 & dat & svartamarkaði & \specialcell{svartamarkaðinum\\  svartamarkaðnum} & svörtumörkuðum & \textls[-5]{svörtumörkuðunum} \\*
 {\footnotesize{svarti\allowbreak ·mark\allowbreak ·aður}} & gen & \textbf{\specialcell{svartamarkaðar\\  svartamarkaðs}} & \specialcell{svartamarkaðarins\\  svartamarkaðsins} & svörtumarkaða & \textls[-5]{svörtumarkaðanna} \\
\cmidrule{1-6}

...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{imper akt sg} & \textit{imper akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{rýja}} & && rýðu  & rýið   & rýjandi &  \textbf{\specialcell{rúið\\ rúð}}  && \multicolumn{2}{l}{\specialcell{\textbf{rúinn} adj\textbf{\textsubscript{6-2}}\\\textbf{rúður} adj\textbf{\textsubscript{2-13}}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{imper akt sg} & \textit{imper akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{þiggja}} & && þiggðu  & þiggið   & þiggjandi &  \textbf{\specialcell{þegið\\ þáð}}  && \multicolumn{2}{l}{\specialcell{\textbf{þeginn} adj\textbf{\textsubscript{6-2}}\\\textbf{þáður} adj\textbf{\textsubscript{2-13}}}} \\*

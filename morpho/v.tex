...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{borga}} & && borgaðu  & borgið   & borgandi &  \textbf{borgað} && borgast & \specialcell{\textbf{borgaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{angra}} & && angraðu  & angrið   & angrandi &  \textbf{angrað} && angrast & \specialcell{\textbf{angraður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
&&{ \textit{e-n} } & stuggar & stuggaði & stuggi & stuggaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{stugga}} & && stuggaðu  & stuggið   & stuggandi &  \textbf{stuggað} && stuggast & \specialcell{\textbf{stuggaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & sakar & sakaði & saki & sakaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{saka}} & && sakaðu  & sakið   & sakandi &  \textbf{sakað} && sakast & \specialcell{\textbf{sakaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & seinkar & seinkaði & seinki & seinkaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{seinka}} & && seinkaðu  & seinkið   & seinkandi &  \textbf{seinkað} && seinkast & \specialcell{\textbf{seinkaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & byrjar & byrjaði & byrji & byrjaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{byrja}} & && byrjaðu  & byrjið   & byrjandi &  \textbf{byrjað} && byrjast & \specialcell{\textbf{byrjaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & hljóðnar & hljóðnaði & hljóðni & hljóðnaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hljóðna}} & && hljóðnaðu  & hljóðnið   & hljóðnandi &  \textbf{hljóðnað} && hljóðnast & \specialcell{\textbf{hljóðnaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & snarkar & snarkaði & snarki & snarkaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{snarka}} & && snarkaðu  & snarkið   & snarkandi &  \textbf{snarkað} && snarkast & \specialcell{\textbf{snarkaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 &&{ \textit{e-m} }& ·reiknast & ·reiknaðist & ·reiknist & ·reiknaðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{mis\allowbreak ·reikna}} & && ·reiknaðu  & ·reiknið   & ·reiknandi &  \textbf{·reiknað} && ·reiknast & \specialcell{\textbf{·reiknaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& talast & talaðist & talist & talaðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{tala}} & && talaðu  & talið   & talandi &  \textbf{talað} && talast & \specialcell{\textbf{talaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{\specialcell{e-m\\það}} }& aflast & aflaðist & aflist & aflaðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{afla}} & && aflaðu  & aflið   & aflandi &  \textbf{aflað} && aflast & \specialcell{\textbf{aflaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& saxast & saxaðist & saxist & saxaðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{saxa}} & && saxaðu  & saxið   & saxandi &  \textbf{saxað} && saxast & \specialcell{\textbf{saxaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{kalla}} & && kallaðu  & kallið   & kallandi &  \textbf{kallað} && kallast & \specialcell{\textbf{kallaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & suddar & suddaði & suddi & suddaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{sudda}} & && suddaðu  & suddið   & suddandi &  \textbf{suddað} && suddast & \specialcell{\textbf{suddaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{\specialcell{e-m\\það}} }& hugsast & hugsaðist & hugsist & hugsaðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hugsa}} & && hugsaðu  & hugsið   & hugsandi &  \textbf{hugsað} && hugsast & \specialcell{\textbf{hugsaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{vara}} & && varaðu  & varið   & varandi &  \textbf{varað} && varast & \specialcell{\textbf{varaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & sáldrar & sáldraði & sáldri & sáldraði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & undrar & undraði & undri & undraði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & hallar & hallaði & halli & hallaði \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& hallast & hallaðist & hallist & hallaðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & urgar & urgaði & urgi & urgaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & hlakkar & hlakkaði & hlakki & hlakkaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & gutlar & gutlaði & gutli & gutlaði \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& gutlast & gutlaðist & gutlist & gutlaðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& ratast & rataðist & ratist & rataðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& heyjast & heyjaðist & heyist & heyjaðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{inn\allowbreak ·sigla}} & && ·siglaðu  & ·siglið    &  \textbf{·siglað} & ·siglast && \specialcell{\textbf{·siglaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin} & \textit{supin refl} && \textit{pp m} \\*
  {\textbf{hand\allowbreak ·fjalla}} & && ·fjallaðu  & ·fjallið    &  \textbf{·fjallað} & ·fjallast && \specialcell{\textbf{·fjallaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& hlekkist & hlekktist & hlekkist & hlekktist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin} & \textit{supin refl} && \textit{pp m} \\*
  {\textbf{hlekkja}} & && hlekkjaðu  & hlekkið    &  \textbf{hlekkjað} & hlekkst && \specialcell{\textbf{hlekkjaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{í\allowbreak ·mynda}} & && ·myndaðu  & ·myndið   & ·myndandi &  \textbf{·myndað}  && \specialcell{\textbf{·myndaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & kitlar & kitlaði & kitli & kitlaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{kitla}} & && kitlaðu  & kitlið   & kitlandi &  \textbf{kitlað}  && \specialcell{\textbf{kitlaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & fjarar & fjaraði & fjari & fjaraði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{fjara}} & && fjaraðu  & fjarið   & fjarandi &  \textbf{fjarað}  && \specialcell{\textbf{fjaraður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & vöknar & vöknaði & vökni & vöknaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{vökna}} & && vöknaðu  & vöknið   & vöknandi &  \textbf{vöknað}  && \specialcell{\textbf{vöknaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & passar & passaði & passi & passaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{passa}} & && passaðu  & passið   & passandi &  \textbf{passað}  && \specialcell{\textbf{passaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & kólnar & kólnaði & kólni & kólnaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{kólna}} & && kólnaðu  & kólnið   & kólnandi &  \textbf{kólnað}  && \specialcell{\textbf{kólnaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & sallar & sallaði & salli & sallaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{salla}} & && sallaðu  & sallið   & sallandi &  \textbf{sallað}  && \specialcell{\textbf{sallaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & dofnar & dofnaði & dofni & dofnaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{dofna}} & && dofnaðu  & dofnið   & dofnandi &  \textbf{dofnað}  && \specialcell{\textbf{dofnaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & harðnar & harðnaði & harðni & harðnaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{harðna}} & && harðnaðu  & harðnið   & harðnandi &  \textbf{harðnað}  && \specialcell{\textbf{harðnaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{kafna}} & && kafnaðu  & kafnið   & kafnandi &  \textbf{kafnað}  && \specialcell{\textbf{kafnaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & sárnar & sárnaði & sárni & sárnaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & stafar & stafaði & stafi & stafaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & fækkar & fækkaði & fækki & fækkaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & lækkar & lækkaði & lækki & lækkaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & brakar & brakaði & braki & brakaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & svipar & svipaði & svipi & svipaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& fipast & fipaðist & fipist & fipaðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{fjalla}} & && fjallaðu  & fjallið    &  \textbf{fjallað}  & \specialcell{\textbf{fjallaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & varðar & varðaði & varði & varðaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & furðar & furðaði & furði & furðaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& heilsast & heilsaðist & heilsist & heilsaðist \\*
...
&&{ \textit{e-n} } & syfjar & syfjaði & syfji & syfjaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{syfja}} & &     & syfjandi &  \textbf{syfjað}  & \specialcell{\textbf{syfjaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & grunar & grunaði & gruni & grunaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{gruna}} & &     & grunandi &  \textbf{grunað}  & \specialcell{\textbf{grunaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & súrnar & súrnaði & súrni & súrnaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{súrna}} & &     & súrnandi &  \textbf{súrnað}  & \specialcell{\textbf{súrnaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & batnar & batnaði & batni & batnaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{batna}} & &     & batnandi &  \textbf{batnað}  & \specialcell{\textbf{batnaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & háttar & háttaði & hátti & háttaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{hátta}} & &     & háttandi &  \textbf{háttað}  & \specialcell{\textbf{háttaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & gránar & gránaði & gráni & gránaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{grána}} & &     & gránandi &  \textbf{gránað}  & \specialcell{\textbf{gránaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & skrjáfar & skrjáfaði & skrjáfi & skrjáfaði \\*
...
&&{ \textit{e-n} } & svimar & svimaði & svimi & svimaði \\*
...
&&{ \textit{\specialcell{e-n\\það}} } & vantar & vantaði & vanti & vantaði \\*
...
&&{ \textit{\specialcell{e-n \\ e-m\\það}} } & munar & munaði & muni & munaði \\*
...
&&{ \textit{e-m} } & vegnar & vegnaði & vegni & vegnaði \\*
...
&&{ \textit{\specialcell{e-m\\það}} } & snjóar & snjóaði & snjói & snjóaði \\*
...
&&{ \textit{það} } & korrar & korraði & korri & korraði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & skánar & skánaði & skáni & skánaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & hitnar & hitnaði & hitni & hitnaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & slitnar & slitnaði & slitni & slitnaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & glampar & glampaði & glampi & glampaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & gagnar & gagnaði & gagni & gagnaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & rökkvar & rökkvaði & rökkvi & rökkvaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &      & \textit{supin} & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{rökkva}} & &      &  \textbf{rökkvað} & rökkvast & \specialcell{\textbf{rökkvaður} \\ adj\textbf{\textsubscript{3-3}}} \\*

\bottomrule

\multirow{2}{*}{{{\textbf{v{\textsubscript{1}}} \Large{\textbf{79}}}}}  &&&  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & stoðar & stoðaði & stoði & stoðaði \\*
...
&&{ \textit{\specialcell{e-n\\það}} } & hélar & hélaði & héli & hélaði \\*

\cmidrule{4-7}
   {\textit{inf}} & &      & \textit{supin}  & \textit{pp m} \\*
  {\textbf{héla}} & &      &  \textbf{hélað}  & \specialcell{\textbf{hélaður} \\ adj\textbf{\textsubscript{3-3}}} \\*

\bottomrule

\multirow{2}{*}{{{\textbf{v{\textsubscript{1}}} \Large{\textbf{81}}}}}  &&&  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n \\ e-m}} } & óar & óaði & ói & óaði \\*
...
&&{ \textit{e-m} } & líkar & líkaði & líki & líkaði \\*
...
&&{ \textit{það} } & haustar & haustaði & hausti & haustaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m \\ e-n\\það}} } & flökrar & flökraði & flökri & flökraði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & hentar & hentaði & henti & hentaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & skeikar & skeikaði & skeiki & skeikaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & bjátar & bjátaði & bjáti & bjátaði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{brjálast}} & &   & brjálastu & brjálist   & brjálast & \specialcell{\textbf{brjálaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& þóknast & þóknaðist & þóknist & þóknaðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{laufgast}} & &     & laufgandi  & laufgast & \specialcell{\textbf{laufgaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &     & \textit{presp}  & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{ör\allowbreak ·magnast}} & &     & ·magnandi  & ·magnast & \specialcell{\textbf{·magnaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{blómgast}} & &       & blómgast & \specialcell{\textbf{blómgaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& heppnast & heppnaðist & heppnist & heppnaðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &       & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{heppnast}} & &       & heppnast & \specialcell{\textbf{heppnaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& vitrast & vitraðist & vitrist & vitraðist \\*
...
\multirow{2}{*}{{{\textbf{v{\textsubscript{1}}} \Large{\textbf{102}}}}}  & &&\textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& skjátlast & skjátlaðist & skjátlist & skjátlaðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{fletta}} & && flettu  & flettið   & flettandi &  \textbf{flett} && flest & \specialcell{\textbf{flettur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & léttir & létti & létti & létti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{létta}} & && léttu  & léttið   & léttandi &  \textbf{létt} && lést & \specialcell{\textbf{léttur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & styttir & stytti & stytti & stytti \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& styttist & styttist & styttist & styttist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{stytta}} & && styttu  & styttið   & styttandi &  \textbf{stytt} && styst & \specialcell{\textbf{styttur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& slettist & slettist & slettist & slettist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{fé\allowbreak ·fletta}} & && ·flettu  & ·flettið   & ·flettandi &  \textbf{·flett}  && \specialcell{\textbf{·flettur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & hættir & hætti & hætti & hætti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{hætta}} & && hættu  & hættið   & hættandi &  \textbf{hætt}  && \specialcell{\textbf{hættur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin}  & \textit{pp m} \\*
  {\textbf{stein\allowbreak ·hætta}} & && ·hættu  & ·hættið    &  \textbf{·hætt}  & \specialcell{\textbf{·hættur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& fréttist & fréttist & fréttist & fréttist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{skipta}} & && skiptu  & skiptið   & skiptandi &  \textbf{skipt} && skipst & \specialcell{\textbf{skiptur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & birtir & birti & birti & birti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{birta}} & && birtu  & birtið   & birtandi &  \textbf{birt} && birst & \specialcell{\textbf{birtur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{hrað\allowbreak ·frysta}} & && ·frystu  & ·frystið   & ·fryst &  \textbf{·fryst}  && \specialcell{\textbf{·frystur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{rista}} & && ristu  & ristið   & ristandi &  \textbf{rist}  && \specialcell{\textbf{ristur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & skröltir & skrölti & skrölti & skrölti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & væntir & vænti & vænti & vænti \\*
...
&&{ \textit{e-n} } & þyrstir & þyrsti & þyrsti & þyrsti \\*
...
&&{ \textit{það} } & hriktir & hrikti & hrikti & hrikti \\*
...
&&{ \textit{\specialcell{e-n\\það}} } & skortir & skorti & skorti & skorti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{kveikja}} & && kveiktu  & kveikið   & kveikjandi &  \textbf{kveikt} && kveikst & \specialcell{\textbf{kveiktur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & velkir & velkti & velki & velkti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{velkja}} & && velktu  & velkið   & velkjandi &  \textbf{velkt} && velkst & \specialcell{\textbf{velktur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & trekkir & trekkti & trekki & trekkti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{trekkja}} & && trekktu  & trekkið   & trekkjandi &  \textbf{trekkt} && trekkst & \specialcell{\textbf{trekktur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hrækja}} & && hræktu  & hrækið   & hrækjandi &  \textbf{hrækt} && hrækst & \specialcell{\textbf{hræktur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & hnykkir & hnykkti & hnykki & hnykkti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin} & \textit{supin refl} && \textit{pp m} \\*
  {\textbf{til\allowbreak ·reykja}} & && ·reyktu  & ·reykið    &  \textbf{·reykt} & ·reykst && \specialcell{\textbf{·reyktur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{rækja}} & && ræktu  & rækið   & rækjandi &  \textbf{rækt}  && \specialcell{\textbf{ræktur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{af\allowbreak ·henda}} & && ·hentu  & ·hendið   & ·hendandi &  \textbf{·hent} && ·henst & \specialcell{\textbf{·hentur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & eldir & elti & eldi & elti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{elda}} & && eltu  & eldið   & eldandi &  \textbf{elt} && elst & \specialcell{\textbf{eltur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & eldir & elti & eldi & elti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{benda}} & && bentu  & bendið   & bendandi &  \textbf{bent} && benst & \specialcell{\textbf{bentur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & lendir & lenti & lendi & lenti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{lenda}} & && lentu  & lendið   & lendandi &  \textbf{lent} && lenst & \specialcell{\textbf{lentur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & hendir & henti & hendi & henti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{synda}} & && syntu  & syndið   & syndandi &  \textbf{synt}  && \specialcell{\textbf{syntur} \\ adj\textbf{\textsubscript{1-10}}} \\*

\bottomrule

\multirow{2}{*}{{{\textbf{v{\textsubscript{2}}} \Large{\textbf{44}}}}}  &&&  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & lyndir & lynti & lyndi & lynti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & gildir & gilti & gildi & gilti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{van\allowbreak ·virða}} & && ·virtu  & ·virðið   & ·virðandi &  \textbf{·virt} && ·virst & \specialcell{\textbf{·virtur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & herðir & herti & herði & herti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{herða}} & && hertu  & herðið   & herðandi &  \textbf{hert} && herst & \specialcell{\textbf{hertur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{fjöl\allowbreak ·yrða}} & && ·yrtu  & ·yrðið   & ·yrðandi &  \textbf{·yrt} && ·yrst & \specialcell{\textbf{·yrtur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& virðist & virtist & virðist & virtist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{girða}} & && girtu  & girðið   & girðandi &  \textbf{girt}  && \specialcell{\textbf{girtur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{bæta}} & && bættu  & bætið   & bætandi &  \textbf{bætt} && bæst & \specialcell{\textbf{bættur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & veitir & veitti & veiti & veitti \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& veitist & veittist & veitist & veittist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{veita}} & && veittu  & veitið   & veitandi &  \textbf{veitt} && veist & \specialcell{\textbf{veittur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & vætir & vætti & væti & vætti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{væta}} & && vættu  & vætið   & vætandi &  \textbf{vætt} && væst & \specialcell{\textbf{vættur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{flýta}} & && flýttu  & flýtið   & flýtandi &  \textbf{flýtt} && flýst & \specialcell{\textbf{flýttur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin} & \textit{supin refl} && \textit{pp m} \\*
  {\textbf{ger\allowbreak ·nýta}} & && ·nýttu  & ·nýtið    &  \textbf{·nýtt} & ·nýst && \specialcell{\textbf{·nýttur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{græta}} & && grættu  & grætið   & grætandi &  \textbf{grætt}  && \specialcell{\textbf{grættur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{smella}} & && smelltu  & smellið   & smellandi &  \textbf{smellt} && smellst & \specialcell{\textbf{smelltur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & leysir & leysti & leysi & leysti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{leysa}} & && leystu  & leysið   & leysandi &  \textbf{leyst} && leyst & \specialcell{\textbf{leystur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & grynnir & grynnti & grynni & grynnti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{grynna}} & && grynntu  & grynnið   & grynnandi &  \textbf{grynnt} && grynnst & \specialcell{\textbf{grynntur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & hleypir & hleypti & hleypi & hleypti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hleypa}} & && hleyptu  & hleypið   & hleypandi &  \textbf{hleypt} && hleypst & \specialcell{\textbf{hleyptur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & lýsir & lýsti & lýsi & lýsti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{lýsa}} & && lýstu  & lýsið   & lýsandi &  \textbf{lýst} && lýst & \specialcell{\textbf{lýstur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & hellir & hellti & helli & hellti \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& hellist & helltist & hellist & helltist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hella}} & && helltu  & hellið   & hellandi &  \textbf{hellt} && hellst & \specialcell{\textbf{helltur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{inna}} & && inntu  & innið   & innandi &  \textbf{innt} && innst & \specialcell{\textbf{inntur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& sinnast & sinnaðist & sinnist & sinnaðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{sinna}} & && sinntu  & sinnið   & sinnandi &  \textbf{sinnt} && sinnast & \specialcell{\textbf{sinntur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & snerpir & snerpti & snerpi & snerpti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{verpa}} & && verptu  & verpið   & verpandi &  \textbf{verpt}  && \specialcell{\textbf{orpinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{af\allowbreak ·læsa}} & && ·læstu  & ·læsið   & ·læsandi &  \textbf{·læst}  && \specialcell{\textbf{·læstur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & hryllir & hryllti & hrylli & hryllti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & sleppir & sleppti & sleppi & sleppti \\*
...
&&{ \textit{e-n} } & fýsir & fýsti & fýsi & fýsti \\*
...
&&{ \textit{\specialcell{e-n\\það}} } & hillir & hillti & hilli & hillti \\*
...
&&{ \textit{það} } & væsir & væsti & væsi & væsti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{byggja}} & && byggðu  & byggið   & byggjandi &  \textbf{byggt} && byggst & \specialcell{\textbf{byggður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & lægir & lægði & lægi & lægði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{lægja}} & && lægðu  & lægið   & lægjandi &  \textbf{lægt} && lægst & \specialcell{\textbf{lægður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & skyggir & skyggði & skyggi & skyggði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{skyggja}} & && skyggðu  & skyggið   & skyggjandi &  \textbf{skyggt} && skyggst & \specialcell{\textbf{skyggður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{fram\allowbreak ·leigja}} & && ·leigðu  & ·leigið   & ·leigjandi &  \textbf{·leigt} && ·leigst & \specialcell{\textbf{·leigður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & hægir & hægði & hægi & hægði \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& hægist & hægðist & hægist & hægðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{syrgja}} & && syrgðu  & syrgið   & syrgjandi &  \textbf{syrgt}  && \specialcell{\textbf{syrgður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & nægir & nægði & nægi & nægði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{gera}} & && gerðu  & gerið   & gerandi &  \textbf{gert} && gerst & \specialcell{\textbf{gerður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & stærir & stærði & stæri & stærði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{stæra}} & && stærðu  & stærið   & stærandi &  \textbf{stært} && stærst & \specialcell{\textbf{stærður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & kyrrir & kyrrði & kyrri & kyrrði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{kyrra}} & && kyrrðu  & kyrrið   & kyrrandi &  \textbf{kyrrt} && kyrrst & \specialcell{\textbf{kyrrður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & deyfir & deyfði & deyfi & deyfði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{deyfa}} & && deyfðu  & deyfið   & deyfandi &  \textbf{deyft} && deyfst & \specialcell{\textbf{deyfður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& lærist & lærðist & lærist & lærðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{læra}} & && lærðu  & lærið   & lærandi &  \textbf{lært} && lærst & \specialcell{\textbf{lærður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{\specialcell{e-m\\það}} }& heyrist & heyrðist & heyrist & heyrðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{heyra}} & && heyrðu  & heyrið   & heyrandi &  \textbf{heyrt} && heyrst & \specialcell{\textbf{heyrður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{lag\allowbreak ·færa}} & && ·færðu  & ·færið   & ·færandi &  \textbf{·fært} && ·færst & \specialcell{\textbf{·færður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& leyfist & leyfðist & leyfist & leyfðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{leyfa}} & && leyfðu  & leyfið   & leyfandi &  \textbf{leyft} && leyfst & \specialcell{\textbf{leyfður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & horfir & horfði & horfi & horfði \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& horfist & horfðist & horfist & horfðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{að\allowbreak ·hæfa}} & && ·hæfðu  & ·hæfið   & ·hæfandi &  \textbf{·hæft}  && \specialcell{\textbf{·hæfður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{af\allowbreak ·má}} & && ·máðu  & ·máið   & ·máandi &  \textbf{·máð} && ·máðst & \specialcell{\textbf{·máður} \\ adj\textbf{\textsubscript{2-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin} & \textit{supin refl} && \textit{pp m} \\*
  {\textbf{skrá}} & && skráðu  & skráið    &  \textbf{skráð} & skráðst && \specialcell{\textbf{skráður} \\ adj\textbf{\textsubscript{2-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& láist & láðist & láist & láðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin}  & \textit{pp m} \\*
  {\textbf{þrá}} & && þráðu  & þráið    &  \textbf{þráð}  & \specialcell{\textbf{þráður} \\ adj\textbf{\textsubscript{2-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & gljáir & gljáði & gljái & gljáði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin}  & \textit{pp m} \\*
  {\textbf{gljá}} & && gljáðu  & gljáið    &  \textbf{gljáð}  & \specialcell{\textbf{gljáður} \\ adj\textbf{\textsubscript{2-12}}} \\*
...
&&{ \textit{það} } & bráir & bráði & brái & bráði \\*
...
&&{ \textit{e-n} } & varir & varði & vari & varði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{fylgja}} & && fylgdu  & fylgið   & fylgjandi &  \textbf{fylgt} && fylgst & \specialcell{\textbf{fylgdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & lengir & lengdi & lengi & lengdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{lengja}} & && lengdu  & lengið   & lengjandi &  \textbf{lengt} && lengst & \specialcell{\textbf{lengdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & þyngir & þyngdi & þyngi & þyngdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{þyngja}} & && þyngdu  & þyngið   & þyngjandi &  \textbf{þyngt} && þyngst & \specialcell{\textbf{þyngdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & þrengir & þrengdi & þrengi & þrengdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{þrengja}} & && þrengdu  & þrengið   & þrengjandi &  \textbf{þrengt} && þrengst & \specialcell{\textbf{þrengdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& svelgist & svelgdist & svelgist & svelgdist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{svelgja}} & && svelgdu  & svelgið   & svelgjandi &  \textbf{svelgt} && svelgst & \specialcell{\textbf{svelgdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{fram\allowbreak ·fylgja}} & && ·fylgdu  & ·fylgið   & ·fylgjandi &  \textbf{·fylgt} && ·fylgst & \specialcell{\textbf{·fylgdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & kyngir & kyngdi & kyngi & kyngdi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{hengja}} & && hengdu  & hengið   & hengjandi &  \textbf{hengt}  && \specialcell{\textbf{hengdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & velgir & velgdi & velgi & velgdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{velgja}} & && velgdu  & velgið   & velgjandi &  \textbf{velgt}  && \specialcell{\textbf{velgdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
&&{ \textit{e-n} } & svengir & svengdi & svengi & svengdi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hvíla}} & && hvíldu  & hvílið   & hvílandi &  \textbf{hvílt} && hvílst & \specialcell{\textbf{hvíldur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & skemmir & skemmdi & skemmi & skemmdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{skemma}} & && skemmdu  & skemmið   & skemmandi &  \textbf{skemmt} && skemmst & \specialcell{\textbf{skemmdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & kælir & kældi & kæli & kældi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{kæla}} & && kældu  & kælið   & kælandi &  \textbf{kælt} && kælst & \specialcell{\textbf{kældur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& sýnist & sýndist & sýnist & sýndist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{sýna}} & && sýndu  & sýnið   & sýnandi &  \textbf{sýnt} && sýnst & \specialcell{\textbf{sýndur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{gagn\allowbreak ·rýna}} & && ·rýndu  & ·rýnið   & ·rýnandi &  \textbf{·rýnt} && ·rýnst & \specialcell{\textbf{·rýndur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & ·þyrmir & ·þyrmdi & ·þyrmi & ·þyrmdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{yfir\allowbreak ·þyrma}} & && ·þyrmdu  & ·þyrmið   & ·þyrmandi &  \textbf{·þyrmt} && ·þyrmst & \specialcell{\textbf{·þyrmdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & þyrmir & þyrmdi & þyrmi & þyrmdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{þyrma}} & && þyrmdu  & þyrmið   & þyrmandi &  \textbf{þyrmt} && þyrmst & \specialcell{\textbf{þyrmdur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & lygnir & lygndi & lygni & lygndi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & dembir & dembdi & dembi & dembdi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& hefnist & hefndist & hefnist & hefndist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{mæla}} & && mældu  & mælið   & mælandi &  \textbf{mælt}  && \specialcell{\textbf{mældur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{kenna}} & && kenndu  & kennið   & kennandi &  \textbf{kennt}  && \specialcell{\textbf{kenndur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & vænir & vændi & væni & vændi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{væna}} & && vændu  & vænið   & vænandi &  \textbf{vænt}  && \specialcell{\textbf{vændur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & stefnir & stefndi & stefni & stefndi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{stefna}} & && stefndu  & stefnið   & stefnandi &  \textbf{stefnt}  && \specialcell{\textbf{stefndur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & sæmir & sæmdi & sæmi & sæmdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{sæma}} & && sæmdu  & sæmið   & sæmandi &  \textbf{sæmt}  && \specialcell{\textbf{sæmdur} \\ adj\textbf{\textsubscript{2-17}}} \\*

\bottomrule

\multirow{2}{*}{{{\textbf{v{\textsubscript{2}}} \Large{\textbf{159}}}}}  &&&  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & dimmir & dimmdi & dimmi & dimmdi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & hvolfir & hvolfdi & hvolfi & hvolfdi \\*
...
&&{ \textit{e-n} } & dreymir & dreymdi & dreymi & dreymdi \\*
...
&&{ \textit{\specialcell{e-m\\það}} } & rignir & rigndi & rigni & rigndi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{klæða}} & && klæddu  & klæðið   & klæðandi &  \textbf{klætt} && klæðst & \specialcell{\textbf{klæddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & greiðir & greiddi & greiði & greiddi \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{það} }& greiðist & greiddist & greiðist & greiddist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{greiða}} & && greiddu  & greiðið   & greiðandi &  \textbf{greitt} && greiðst & \specialcell{\textbf{greiddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& leiðist & leiddist & leiðist & leiddist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{leiða}} & && leiddu  & leiðið   & leiðandi &  \textbf{leitt} && leiðst & \specialcell{\textbf{leiddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{arf\allowbreak ·leiða}} & && ·leiddu  & ·leiðið   & ·leiðandi &  \textbf{·leitt} && ·leiðst & \specialcell{\textbf{·leiddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & hlýðir & hlýddi & hlýði & hlýddi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{prýða}} & && prýddu  & prýðið   & prýðandi &  \textbf{prýtt}  && \specialcell{\textbf{prýddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & þíðir & þíddi & þíði & þíddi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{þíða}} & && þíddu  & þíðið   & þíðandi &  \textbf{þítt}  && \specialcell{\textbf{þíddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & bryddir & bryddi & bryddi & bryddi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{brydda}} & && bryddu  & bryddið   & bryddandi &  \textbf{brytt}  && \specialcell{\textbf{bryddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & reiðir & reiddi & reiði & reiddi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & flæðir & flæddi & flæði & flæddi \\*

\cmidrule{4-7}
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{flæða}} & &     & flæðandi &  \textbf{flætt}  & \specialcell{\textbf{flæddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & freyðir & freyddi & freyði & freyddi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & blæðir & blæddi & blæði & blæddi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & tórir & tórði & tóri & tórði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &   & \textit{i refl sg} & \textit{i refl pl}   & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{kvænast}} & &   & kvænstu & kvænist   & kvænst & \specialcell{\textbf{kvæntur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &     & \textit{presp}  & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{rætast}} & &     & rætandi  & ræst & \specialcell{\textbf{rættur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &       & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{streitast}} & &       & streist & \specialcell{\textbf{streittur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &       & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{heykjast}} & &       & heykst & \specialcell{\textbf{heyktur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &      & \textit{supin} & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{úr\allowbreak ·eldast}} & &      &  \textbf{·elt} & ·elst & \specialcell{\textbf{·eltur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& endist & entist & endist & entist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &       & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hærast}} & &       & hærst & \specialcell{\textbf{hærður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &       & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{mægjast}} & &       & mægst & \specialcell{\textbf{mægður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\multirow{2}{*}{{{\textbf{v{\textsubscript{2}}} \Large{\textbf{209}}}}}  & &&\textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& gremst & gramdist & gremjist & gremdist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &       & \textit{supin refl} & \textit{pp m} \\*
  {\textbf{endur\allowbreak ·fæðast}} & &       & ·fæðst & \specialcell{\textbf{·fæddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{flétta}} & && \specialcell{fléttaðu\\ fléttu}  & fléttið   & fléttandi &  \textbf{\specialcell{fléttað\\ flétt}} && fléttast & \specialcell{\textbf{fléttaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{slétta}} & && \specialcell{sléttaðu\\ sléttu}  & sléttið   & sléttandi &  \textbf{\specialcell{sléttað\\ slétt}} && \specialcell{sléttast\\ slést} & \specialcell{\textbf{sléttaður} adj \textbf{\textsubscript{2-7}}\\\textbf{ sléttur} adj \textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{pípa}} & && \specialcell{pípaðu\\ píptu}  & pípið   & pípandi &  \textbf{\specialcell{pípað\\ pípt}} && pípast & \specialcell{\textbf{pípaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{játa}} & && \specialcell{játaðu\\ játtu}  & játið   & játandi &  \textbf{\specialcell{játað\\ játt}} && játast & \specialcell{\textbf{játaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & semur & samdi & semji & semdi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{semja}} & && semdu  & semjið   & semjandi &  \textbf{samið} && samist & \specialcell{\textbf{saminn} \\ adj\textbf{\textsubscript{6-8}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{telja}} & && teldu  & teljið   & teljandi &  \textbf{talið} && talist & \specialcell{\textbf{talinn} \\ adj\textbf{\textsubscript{6-8}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& dvelst & dvaldist & dveljist & dveldist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{endur\allowbreak ·semja}} & && ·semdu  & ·semjið   & ·semjandi &  \textbf{·samið}  && \specialcell{\textbf{·saminn} \\ adj\textbf{\textsubscript{6-8}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{smyrja}} & && smyrðu  & smyrjið   & smyrjandi &  \textbf{smurt} && smurst & \specialcell{\textbf{smurður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{þrá\allowbreak ·spyrja}} & && ·spyrðu  & ·spyrjið   & ·spyrjandi &  \textbf{·spurt}  && \specialcell{\textbf{·spurður} \\ adj\textbf{\textsubscript{2-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-n} }& vefst & vafðist & vefjist & vefðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{vefja}} & && vefðu  & vefjið   & vefjandi &  \textbf{vafið} && vafist & \specialcell{\textbf{vafinn} \\ adj\textbf{\textsubscript{6-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{tefja}} & && tefðu  & tefjið   & tefjandi &  \textbf{tafið} && tafist & \specialcell{\textbf{tafinn} \\ adj\textbf{\textsubscript{}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{merja}} & && merðu  & merjið   & merjandi &  \textbf{marið} && marist & \specialcell{\textbf{marinn} \\ adj\textbf{\textsubscript{}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{segja}} & && segðu  & segið   & segjandi &  \textbf{sagt} && sagst & \specialcell{\textbf{sagður} \\ adj\textbf{\textsubscript{2-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{af\allowbreak ·segja}} & && ·segðu  & ·segið   & ·segjandi &  \textbf{·sagt}  && \specialcell{\textbf{·sagður} \\ adj\textbf{\textsubscript{2-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{þegja}} & && þegiðu  & þegið   & þegjandi &  \textbf{þagað}  && \specialcell{\textbf{þagaður} \\ adj\textbf{\textsubscript{3-1}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hafa}} & && hafðu  & hafið   & hafandi &  \textbf{haft} && hafst & \specialcell{\textbf{hafður} \\ adj\textbf{\textsubscript{2-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{skipu\allowbreak ·leggja}} & && ·leggðu  & ·leggið   & ·leggjandi &  \textbf{·lagt} && ·lagst & \specialcell{\textbf{·lagður} \\ adj\textbf{\textsubscript{2-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & leggur & lagði & leggi & legði \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& leggst & lagðist & leggist & legðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{kort\allowbreak ·leggja}} & && ·leggðu  & ·leggið   & ·leggjandi &  \textbf{·lagt}  && \specialcell{\textbf{·lagður} \\ adj\textbf{\textsubscript{2-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{selja}} & && seldu  & seljið   & seljandi &  \textbf{selt} && selst & \specialcell{\textbf{seldur} \\ adj\textbf{\textsubscript{2-14}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{kyrr\allowbreak ·setja}} & && ·settu  & ·setjið   & ·setjandi &  \textbf{·sett} && ·sest & \specialcell{\textbf{·settur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{á\allowbreak ·setja}} & && ·settu  & ·setjið   & ·setjandi &  \textbf{·sett}  && \specialcell{\textbf{·settur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{að\allowbreak ·skilja}} & && ·skildu  & ·skiljið   & ·skiljandi &  \textbf{·skilið} && ·skilist & \specialcell{\textbf{·skilinn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& skilst & skildist & skiljist & skildist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{skilja}} & && skildu  & skiljið   & skiljandi &  \textbf{skilið} && skilist & \specialcell{\textbf{skilinn} \\ adj\textbf{\textsubscript{6-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{á\allowbreak ·skilja}} & && ·skildu  & ·skiljið   & ·skiljandi &  \textbf{·skilið}  && \specialcell{\textbf{·skilinn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& dylst & duldist & dyljist & dyldist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{dylja}} & && dyldu  & dyljið   & dyljandi &  \textbf{dulið} && dulist & \specialcell{\textbf{dulinn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hylja}} & && hyldu  & hyljið   & hyljandi &  \textbf{hulið} && hulist & \specialcell{\textbf{hulinn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{stynja}} & && styndu  & stynjið   & stynjandi &  \textbf{stunið}  && \specialcell{\textbf{stuninn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & drynur & drundi & drynji & dryndi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{þylja}} & &     & þyljandi &  \textbf{þulið} & þulist & \specialcell{\textbf{þulinn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{hrynja}} & &     & hrynjandi &  \textbf{hrunið}  & \specialcell{\textbf{hruninn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & dynur & dundi & dynji & dyndi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & vill & vildi & vilji & vildi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{styðja}} & && styddu  & styðjið   & styðjandi &  \textbf{stutt} && stuðst & \specialcell{\textbf{studdur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{bryðja}} & && bryddu  & bryðjið   & bryðjandi &  \textbf{brutt}  && \specialcell{\textbf{bruddur} \\ adj\textbf{\textsubscript{2-18}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & uggir & uggði & uggi & yggði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & hrekur & hrakti & hreki & hrekti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hrekja}} & && hrektu  & hrekið   & hrekjandi &  \textbf{hrakið} && hrakist & \specialcell{\textbf{hrakinn} \\ adj\textbf{\textsubscript{6-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{glepja}} & && gleptu  & glepjið   & glepjandi &  \textbf{glapið} && glapist & \specialcell{\textbf{glapinn} \\ adj\textbf{\textsubscript{6-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{lepja}} & && leptu  & lepjið   & lepjandi &  \textbf{lapið}  && \specialcell{\textbf{lapinn} \\ adj\textbf{\textsubscript{6-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{fletja}} & && flettu  & fletjið   & fletjandi &  \textbf{flatt} && flast & \specialcell{\textbf{flattur} \\ adj\textbf{\textsubscript{1-11}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{hvetja}} & && hvettu  & hvetjið   & hvetjandi &  \textbf{hvatt}  && \specialcell{\textbf{hvattur} \\ adj\textbf{\textsubscript{1-11}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{tyggja}} & && tyggðu  & tyggið   & tyggjandi &  \textbf{tuggið} && tuggist & \specialcell{\textbf{tugginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{yrja}} & && yrðu  & yrjið   & yrjandi &  \textbf{urið} && urist & \specialcell{\textbf{urinn} \\ adj\textbf{\textsubscript{}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{flýja}} & && flýðu  & flýið   & flýjandi &  \textbf{flúið}  && \specialcell{\textbf{flúinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{lýja}} & && lýðu  & lýið   & lýjandi &  \textbf{\specialcell{lúið\\ lúð}} && \specialcell{lúðst\\ lúist} & \specialcell{\textbf{lúður} adj \textbf{\textsubscript{2-12}}\\\textbf{ lúinn} adj \textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{rýja}} & && rýðu  & rýið   & rýjandi &  \textbf{\specialcell{rúið\\ rúð}}  && \specialcell{\textbf{rúinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{knýja}} & && knýðu  & knýið   & knýjandi &  \textbf{knúið}  && \specialcell{\textbf{knúinn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{seðja}} & && seddu  & seðjið   & seðjandi &  \textbf{satt} && saðst & \specialcell{\textbf{saddur} \\ adj\textbf{\textsubscript{2-19}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{yrkja}} & && yrktu  & yrkið   & yrkjandi &  \textbf{ort} && orst & \specialcell{\textbf{ortur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{lykja}} & && lyktu  & lykið   & lykjandi &  \textbf{lukið} && lukist & \specialcell{\textbf{lukinn} \\ adj\textbf{\textsubscript{6-11}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{flytja}} & && flyttu  & flytjið   & flytjandi &  \textbf{flutt} && flust & \specialcell{\textbf{fluttur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{sel\allowbreak ·flytja}} & && ·flyttu  & ·flytjið   & ·flytjandi &  \textbf{·flutt}  && \specialcell{\textbf{·fluttur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & þarf & þurfti & þurfi & þyrfti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{þiggja}} & && þiggðu  & þiggið   & þiggjandi &  \textbf{\specialcell{þegið\\ þáð}}  && \specialcell{\textbf{þeginn} adj \textbf{\textsubscript{-}}\\\textbf{ þáður} adj \textbf{\textsubscript{2-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{undan\allowbreak ·þiggja}} & && ·þiggðu  & ·þiggið   & ·þiggjandi &  \textbf{·þegið}  && \specialcell{\textbf{·þeginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{slökkva}} & && slökktu  & slökkvið   & slökkvandi &  \textbf{slökkt}  && \specialcell{\textbf{slökktur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &      & \textit{supin}  & \textit{pp m} \\*
  {\textbf{ske}} & &      &  \textbf{skeð}  & \specialcell{\textbf{skeður} \\ adj\textbf{\textsubscript{2-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{snerta}} & && snertu  & snertið   & snertandi &  \textbf{\specialcell{snert\\ snortið}} && snerst & \specialcell{\textbf{snertur} adj \textbf{\textsubscript{1-10}}\\\textbf{ snortinn} adj \textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{róa}} & && róðu  & róið   & róandi &  \textbf{róið}  && \specialcell{\textbf{róinn} \\ adj\textbf{\textsubscript{}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &     & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{gróa}} & &     & gróandi &  \textbf{gróið}  & \specialcell{\textbf{gróinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{snúa}} & && snúðu  & snúið   & snúandi &  \textbf{snúið} && snúist & \specialcell{\textbf{snúinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{sækja}} & && sæktu  & sækið   & sækjandi &  \textbf{sótt} && sóst & \specialcell{\textbf{sóttur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{heim\allowbreak ·sækja}} & && ·sæktu  & ·sækið   & ·sækjandi &  \textbf{·sótt}  && \specialcell{\textbf{·sóttur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & þykir & þótti & þyki & þætti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & gengur & gekk & gangi & gengi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{snið\allowbreak ·ganga}} & && ·gakktu  & ·gangið   & ·gangandi &  \textbf{·gengið}  && \specialcell{\textbf{·genginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{hanga}} & && hangtu  & hangið   & hangandi &  \textbf{hangið}  && \specialcell{\textbf{hanginn} \\ adj\textbf{\textsubscript{6-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{heyja}} & && heyðu  & heyið   & heyjandi &  \textbf{háð} && háðst & \specialcell{\textbf{háður} \\ adj\textbf{\textsubscript{}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{kaupa}} & && kauptu  & kaupið   & kaupandi &  \textbf{keypt}  && \specialcell{\textbf{keyptur} \\ adj\textbf{\textsubscript{1-10}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{ljá}} & && ljáðu  & ljáið   & ljáandi &  \textbf{léð}  && \specialcell{\textbf{léður} \\ adj\textbf{\textsubscript{2-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{ná}} & && náðu  & náið   & náandi &  \textbf{náð} && náðst & \specialcell{\textbf{náður} \\ adj\textbf{\textsubscript{2-12}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{spýja}} & && spýðu  & spýið   & spýjandi &  \textbf{spúð}  && \specialcell{\textbf{spúinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{velta}} & && veltu  & veltið   & veltandi &  \textbf{oltið}  && \specialcell{\textbf{oltinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{sofa}} & && sofðu  & sofið   & sofandi &  \textbf{sofið}  && \specialcell{\textbf{sofinn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{þrá\allowbreak ·biðja}} & && ·biddu  & ·biðjið   & ·biðjandi &  \textbf{·beðið} && ·beðist & \specialcell{\textbf{·beðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{róg\allowbreak ·bera}} & && ·berðu  & ·berið   & ·berandi &  \textbf{·borið} && ·borist & \specialcell{\textbf{·borinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & ber & bar & beri & bæri \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{\specialcell{e-m\\það}} }& berst & barst & berist & bærist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& gefst & gafst & gefist & gæfist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{lesa}} & && lestu  & lesið   & lesandi &  \textbf{lesið}  && \specialcell{\textbf{lesinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{leka}} & && lektu  & lekið   & lekandi &  \textbf{lekið}  && \specialcell{\textbf{lekinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{á\allowbreak ·kveða}} & && ·kveddu  & ·kveðið   & ·kveðandi &  \textbf{·kveðið}  && \specialcell{\textbf{·kveðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{nema}} & && nemdu  & nemið   & nemandi &  \textbf{numið}  && \specialcell{\textbf{numinn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{saman\allowbreak ·bera}} & && ·berðu  & ·berið   & ·berndi &  \textbf{·borið}  && \specialcell{\textbf{·borinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{sitja}} & && sittu  & sitjið   & sitjandi &  \textbf{setið}  && \specialcell{\textbf{setinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & rennur & rann & renni & rynni \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{renna}} & && renndu  & rennið   & rennandi &  \textbf{runnið}  && \specialcell{\textbf{runninn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{brenna}} & && brenndu  & brennið   & brennandi &  \textbf{brunnið}  && \specialcell{\textbf{brunninn} \\ adj\textbf{\textsubscript{6-7}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{drekka}} & && drekktu  & drekkið   & drekkandi &  \textbf{drukkið}  && \specialcell{\textbf{drukkinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & brestur & brast & bresti & brysti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{bresta}} & && brestu  & brestið   & brestandi &  \textbf{brostið}  && \specialcell{\textbf{brostinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & dettur & datt & detti & dytti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{detta}} & && dettu  & dettið   & dettandi &  \textbf{dottið}  && \specialcell{\textbf{dottinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & smellur & small & smelli & smylli \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{smella}} & && smelltu  & smellið   & smellandi &  \textbf{smollið}  && \specialcell{\textbf{smollinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{sleppa}} & && slepptu  & sleppið   & sleppandi &  \textbf{sloppið}  && \specialcell{\textbf{sloppinn} \\ adj\textbf{\textsubscript{}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{skjálfa}} & && skjálfðu  & skjálfið   & skjálfandi &  \textbf{skolfið}  && \specialcell{\textbf{skolfinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{gjalla}} & &  & gjallið   & gjallandi &  \textbf{gollið}  & \specialcell{\textbf{gollinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& finnst & fannst & finnist & fyndist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & þverr & þvarr & þverri & þyrri \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{þverra}} & && þverrðu  & þverrið   & þverrandi &  \textbf{þorrið}  && \specialcell{\textbf{þorrinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{svelta}} & && sveltu  & sveltið   & sveltandi &  \textbf{soltið}  && \specialcell{\textbf{soltinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{hverfa}} & && hverfðu  & hverfið   & hverfandi &  \textbf{horfið}  && \specialcell{\textbf{horfinn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
  ...
  {\textbf{svella}} & &  & svellið   & svellandi &  \textbf{sollið} & svellast && \specialcell{\textbf{sollinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & verður & varð & verði & yrði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt pl}   & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{verða}} & &  & verðið   & verðandi &  \textbf{orðið}  & \specialcell{\textbf{orðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & vindur & vatt & vindi & yndi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{vinda}} & && \specialcell{vittu\\ vintu}  & vindið   & vindandi &  \textbf{undið} && undist & \specialcell{\textbf{vindaður} \\ adj\textbf{\textsubscript{3-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & stingur & stakk & stingi & styngi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{undir\allowbreak ·stinga}} & && ·stingtu  & ·stingið   & ·stingandi &  \textbf{·stungið}  && \specialcell{\textbf{·stunginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{springa}} & && springdu  & springið   & springandi &  \textbf{sprungið}  && \specialcell{\textbf{sprunginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{gjalda}} & && gjaltu  & gjaldið   & gjaldandi &  \textbf{goldið}  && \specialcell{\textbf{goldinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{höggva}} & && höggðu  & höggvið   & höggvandi &  \textbf{\specialcell{höggvið\\ höggið\\ hoggið}} && \specialcell{höggvist\\ höggist\\ hoggist} & \specialcell{\textbf{höggvinn} adj \textbf{\textsubscript{6-2}}\\\textbf{ högginn} adj \textbf{\textsubscript{6-2}}\\\textbf{ hogginn} adj \textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{njóta}} & && njóttu  & njótið   & njótandi &  \textbf{notið} && notist & \specialcell{\textbf{notinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{kljúfa}} & && kljúfðu  & kljúfið   & kljúfandi &  \textbf{klofið} && klofist & \specialcell{\textbf{klofinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & brýtur & braut & brjóti & bryti \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & lýkur & lauk & ljúki & lyki \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & skýtur & skaut & skjóti & skyti \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& skýst & skaust & skjótist & skytist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{háls\allowbreak ·brjóta}} & && ·brjóttu  & ·brjótið   & ·brjóndi &  \textbf{·brotið}  && \specialcell{\textbf{·brotinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{ljúga}} & && ljúgðu  & ljúgið   & ljúgandi &  \textbf{logið}  && \specialcell{\textbf{loginn} \\ adj\textbf{\textsubscript{6-2}}} \\*

\bottomrule

\multirow{2}{*}{{{\textbf{v{\textsubscript{6}}} \Large{\textbf{53}}}}}  &&&  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & hrýs & hraus & hrjósi & hrysi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & fellur & féll & falli & félli \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& fellst & féllst & fallist & féllist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt pl}   & \textit{presp} & \textit{supin} & \textit{supin refl} && \textit{pp m} \\*
  {\textbf{falla}} & &  & fallið   & fallandi &  \textbf{fallið} & fallist && \specialcell{\textbf{fallinn} \\ adj\textbf{\textsubscript{6-4}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt pl}   & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{kol\allowbreak ·falla}} & &  & ·fallið   & ·fallandi &  \textbf{·fallið}  & \specialcell{\textbf{·fallinn} \\ adj\textbf{\textsubscript{6-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{heita}} & && heittu  & heitið   & heitandi &  \textbf{heitið}  && \specialcell{\textbf{heitinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & heldur & hélt & haldi & héldi \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& helst & hélst & haldist & héldist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{inni\allowbreak ·halda}} & && ·haltu  & ·haldið   & ·haldandi &  \textbf{·haldið}  && \specialcell{\textbf{·haldinn} \\ adj\textbf{\textsubscript{6-3}}} \\*
...
&&{ \textit{e-m} } & ·víkur & \specialcell{·vék\\  ·veik} & ·víki & ·viki \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{leika}} & && leiktu  & leikið   & leikandi &  \textbf{leikið}  && \specialcell{\textbf{leikinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{bíta}} & && bíttu  & bítið   & bítandi &  \textbf{bitið} && bitist & \specialcell{\textbf{bitinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{sníða}} & && sníddu  & sníðið   & sníðandi &  \textbf{sniðið} && sniðist & \specialcell{\textbf{sniðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & líður & leið & líði & liði \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& líðst & leiðst & líðist & liðist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{líða}} & && líddu  & líðið   & líðandi &  \textbf{liðið} && liðist & \specialcell{\textbf{liðinn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n \\ e-m}} } & svíður & sveið & svíði & sviði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & drífur & dreif & drífi & drifi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{drífa}} & && drífðu  & drífið   & drífandi &  \textbf{drifið}  && \specialcell{\textbf{drifinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & stígur & steig & stígi & stigi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{stíga}} & && stígðu  & stígið   & stígandi &  \textbf{stigið}  && \specialcell{\textbf{stiginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & sígur & seig & sígi & sigi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{síga}} & && sígðu  & sígið   & sígandi &  \textbf{sigið}  && \specialcell{\textbf{siginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & ríður & reið & ríði & riði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{ríða}} & && ríddu  & ríðið   & ríðandi &  \textbf{riðið}  && \specialcell{\textbf{riðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
 ...
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& líst & leist & lítist & litist \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{líta}} & && líttu  & lítið   & lítandi &  \textbf{litið}  && \specialcell{\textbf{litinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{rísa}} & && rístu  & rísið   & rísandi &  \textbf{risið}  && \specialcell{\textbf{risinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{klífa}} & && klífðu  & klífið   & klífandi &  \textbf{klifið}  && \specialcell{\textbf{klifinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{mis\allowbreak ·stíga}} & && ·stígðu  & ·stígið   & ·stígandi &  \textbf{·stigið}  && \specialcell{\textbf{·stiginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{kvíða}} & && kvíddu  & kvíðið   & kvíðandi &  \textbf{kviðið}  && \specialcell{\textbf{kviðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{bíða}} & && bíddu  & bíðið   & bíðandi &  \textbf{beðið}  && \specialcell{\textbf{beðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & skín & skein & skíni & skini \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & blæs & blés & blási & blési \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{blása}} & && blástu  & blásið   & blásandi &  \textbf{blásið}  && \specialcell{\textbf{blásinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{gráta}} & && gráttu  & grátið   & grátandi &  \textbf{grátið}  && \specialcell{\textbf{grátinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{fast\allowbreak ·ráða}} & && ·ráddu  & ·ráðið   & ·ráðandi &  \textbf{·ráðið}  && \specialcell{\textbf{·ráðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{stökkva}} & && stökktu  & stökkvið   & stökkvandi &  \textbf{stokkið}  && \specialcell{\textbf{stokkinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{syngja}} & && syngdu  & syngið   & syngjandi &  \textbf{sungið}  && \specialcell{\textbf{sunginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & býður & bauð & bjóði & byði \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& býðst & bauðst & bjóðist & byðist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & lýstur & laust & ljósti & lysti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{ljósta}} & && ljóstu  & ljóstið   & ljóstandi &  \textbf{lostið}  && \specialcell{\textbf{lostinn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & ·býður & ·bauð & ·bjóði & ·byði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{of\allowbreak ·bjóða}} & && ·bjóddu  & ·bjóðið   & ·bjóðandi &  \textbf{·boðið}  && \specialcell{\textbf{·boðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & þýtur & þaut & þjóti & þyti \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{þjóta}} & && þjóttu  & þjótið   & þjótandi &  \textbf{þotið}  && \specialcell{\textbf{þotinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & sýður & sauð & sjóði & syði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{sjóða}} & && sjóddu  & sjóðið   & sjóðandi &  \textbf{soðið}  && \specialcell{\textbf{soðinn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & fýkur & fauk & fjúki & fyki \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{fjúka}} & && fjúktu  & fjúkið   & fjúkandi &  \textbf{fokið}  && \specialcell{\textbf{fokinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & rýkur & rauk & rjúki & ryki \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{rjúka}} & && rjúktu  & rjúkið   & rjúkandi &  \textbf{rokið}  && \specialcell{\textbf{rokinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{kjósa}} & && kjóstu  & kjósið   & kjósandi &  \textbf{kosið}  && \specialcell{\textbf{kosinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{fyrir\allowbreak ·bjóða}} & && ·bjóddu  & ·bjóðið   & ·bjóðandi &  \textbf{·boðið}  && \specialcell{\textbf{·boðinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{rjúfa}} & && rjúfðu  & rjúfið   & rjúfandi &  \textbf{rofið}  && \specialcell{\textbf{rofinn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{lúta}} & && lúttu  & lútið   & lútandi &  \textbf{lotið}  && \specialcell{\textbf{lotinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & hleður & hlóð & hlaði & hlæði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{hlaða}} & && hladdu  & hlaðið   & hlaðandi &  \textbf{hlaðið} && hlaðist & \specialcell{\textbf{hlaðinn} \\ adj\textbf{\textsubscript{6-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{vega}} & && vegðu  & vegið   & vegandi &  \textbf{vegið} && vegist & \specialcell{\textbf{veginn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-n} } & skefur & skóf & skafi & skæfi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{það} } & grefur & gróf & grafi & græfi \\*
...
&&{ \textit{e-n} } & kelur & kól & kali & kæli \\*

\cmidrule{4-7}
   {\textit{inf}} & &      & \textit{supin}  & \textit{pp m} \\*
  {\textbf{kala}} & &      &  \textbf{kalið}  & \specialcell{\textbf{kalinn} \\ adj\textbf{\textsubscript{6-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & vex & óx & vaxi & yxi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt pl}   & \textit{presp} & \textit{supin}  & \textit{pp m} \\*
  {\textbf{vaxa}} & &  & vaxið   & vaxandi &  \textbf{vaxið}  & \specialcell{\textbf{vaxinn} \\ adj\textbf{\textsubscript{6-4}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{ausa}} & && austu  & ausið   & ausandi &  \textbf{ausið}  && \specialcell{\textbf{ausinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & stendur & stóð & standi & stæði \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{standa}} & && stattu  & standið   & standandi &  \textbf{staðið} && staðist & \specialcell{\textbf{staðinn} \\ adj\textbf{\textsubscript{6-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{saman\allowbreak ·standa}} & && ·stattu  & ·standið   & ·standandi &  \textbf{·staðið}  && \specialcell{\textbf{·staðinn} \\ adj\textbf{\textsubscript{6-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{vefa}} & && vefðu  & vefið   & vefandi &  \textbf{ofið} && ofist & \specialcell{\textbf{ofinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{draga}} & && dragðu  & dragið   & dragandi &  \textbf{dregið} && dregist & \specialcell{\textbf{dreginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-n\\það}} } & tekur & tók & taki & tæki \\*

\cmidrule{4-7}
 & && \textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& tekst & tókst & takist & tækist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{hand\allowbreak ·taka}} & && ·taktu  & ·takið   & ·takandi &  \textbf{·tekið}  && \specialcell{\textbf{·tekinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{yfir\allowbreak ·draga}} & && ·dragðu  & ·dragið   & ·dragandi &  \textbf{·dregið}  && \specialcell{\textbf{·dreginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{e-m} } & bregður & brá & bregði & brygði \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{skuld\allowbreak ·binda}} & && ·bittu  & ·bindið   & ·bindandi &  \textbf{·bundið}  && \specialcell{\textbf{·bundinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{aka}} & && aktu  & akið   & akandi &  \textbf{ekið} && ekist & \specialcell{\textbf{ekinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & slær & sló & slái & slægi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{skelli\allowbreak ·hlæja}} & && ·hlæðu  & ·hlæið   & ·hlæjandi &  \textbf{·hlegið}  && \specialcell{\textbf{·hleginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{deyja}} & && deyðu  & deyið   & deyjandi &  \textbf{dáið}  && \specialcell{\textbf{dáinn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin} && \textit{supin refl} & \textit{pp m} \\*
  {\textbf{éta}} & && éttu  & étið   & étandi &  \textbf{étið} && étist & \specialcell{\textbf{étinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\multirow{2}{*}{{{\textbf{v{\textsubscript{6}}} \Large{\textbf{142}}}}}  & &&\textit{refl ind praes} & \textit{refl ind pf} & \textit{refl con praes} & \textit{refl con pf} \\*
 &&{ \textit{e-m} }& ·sést & ·sást & ·sjáist & ·sæist \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{undir\allowbreak ·búa}} & && ·búðu  & ·búið   & ·búandi &  \textbf{·búið}  && \specialcell{\textbf{·búinn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & kemur & kom & komi & kæmi \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & liggur & lá & liggi & lægi \\*

\cmidrule{4-7}
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{liggja}} & && liggðu  & liggið   & liggjandi &  \textbf{legið}  && \specialcell{\textbf{leginn} \\ adj\textbf{\textsubscript{6-2}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}    & \textit{supin} & \textit{supin refl} && \textit{pp m} \\*
  {\textbf{þvo}} & && þvoðu  & þvoið    &  \textbf{þvegið} & þvegist && \specialcell{\textbf{þveginn} \\ adj\textbf{\textsubscript{6-6}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   && &  \textit{ind praes} & \textit{ind pf} & \textit{con praes} & \textit{con pf} \\*
&&{ \textit{\specialcell{e-m\\það}} } & er & var & sé & væri \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt sg} & \textit{i akt pl}   & \textit{presp} & \textit{supin}  && \textit{pp m} \\*
  {\textbf{yfir\allowbreak ·fara}} & && ·farðu  & ·farið   & ·farandi &  \textbf{·farið}  && \specialcell{\textbf{·farinn} \\ adj\textbf{\textsubscript{6-3}}} \\*
...
\cmidrule{4-7} \cmidrule{9-12}
   ...
   {\textit{inf}} & &  & \textit{i akt pl}   & \textit{presp} & \textit{supin} & \textit{supin refl} && \textit{pp m} \\*
  {\textbf{vinna}} & &  & vinnið   & vinnandi &  \textbf{unnið} & unnist && \specialcell{\textbf{unninn} \\ adj\textbf{\textsubscript{6-16}}} \\*
